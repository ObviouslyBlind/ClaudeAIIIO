...
- [x] Pixel teal pier crate (`/g/teal82` FAIL TEAL — buried in cargo slab)
- [ ] Pixel teal pier crate (`http://localhost:8787/g/teal83`). Shells deferred: seaward spawn, no RMB)
