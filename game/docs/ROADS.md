...
- A **circus** is one clover footprint (circulatory ring + flared arms) plus a grass island. Ribbons **stop on that outline**. Give-way dashes sit on each entry. Do not earcut a holed Clipper keyhole; do not draw 12 m black rectangles into the grass.
