...
- A **circus** is a `RingGeometry` (the join surface) plus a grass island. Duals **stop in the arm flare**, not on the outer face as a square prism. Each arm gets a **smooth fillet flare**; do not Clipper-union those into the doughnut. Give-way dashes sit on the entry. Do not earcut a holed Clipper keyhole; do not draw 12 m black rectangles into the grass.
