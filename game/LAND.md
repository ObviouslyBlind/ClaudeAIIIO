...
- Tap the **$ price tag** on a lot → card with the property name, PAPER cost, **Lease** or **Close**. Left-click empty ground still walks. **Lease** (PAPER) → it is yours. **Develop** opens a catalogue (house, shop, house with shop, small farm, warehouse, factory). Then tap your leased parcel to place that type. NPC lots still show farm / stall.
