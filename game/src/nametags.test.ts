...
describe("outdoor PAPER nametags", () => {
  it("keeps a kraft folded corner, punch-hole, clip, string, pin, tab, stud, rivet, bead, clasp, loop, washer, eyelet, snap, prong, slot, stitch, and still stamps PAPER", () => {
    ...
    expect(NAMETAG_EYELET).toBe(true);
    expect(NAMETAG_SNAP).toBe(true);
    expect(NAMETAG_PRONG).toBe(true);
    expect(NAMETAG_SLOT).toBe(true);
    expect(NAMETAG_STITCH).toBe(true);
    ...
    const eyelet = makeNametagEyelet();
    expect(eyelet.userData.part).toBe("eyelet");
    expect(eyelet.userData.mode).toBe("PAPER");
    expect(eyelet.geometry.type).toBe("BoxGeometry");
    expect((eyelet.material as THREE.MeshLambertMaterial).color.getHex()).toBe(0xc4b496);
    const ey = (eyelet.geometry as THREE.BoxGeometry).parameters;
    expect(ey.width).toBeLessThan(0.12);
    expect(ey.height).toBeLessThan(0.12);
    expect(ey.depth).toBeLessThan(0.12);
    expect(eyelet.position.distanceTo(clip.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(cord.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(pin.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(tab.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(stud.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(rivet.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(bead.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(clasp.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(loop.position)).toBeGreaterThan(0.25);
    expect(eyelet.position.distanceTo(washer.position)).toBeGreaterThan(0.25);

    const snap = makeNametagSnap();
    expect(snap.userData.part).toBe("snap");
    expect(snap.userData.mode).toBe("PAPER");
    expect(snap.geometry.type).toBe("BoxGeometry");
    expect((snap.material as THREE.MeshLambertMaterial).color.getHex()).toBe(0xf2d2a8);
    const sn = (snap.geometry as THREE.BoxGeometry).parameters;
    expect(sn.width).toBeLessThan(0.12);
    expect(sn.height).toBeLessThan(0.12);
    expect(sn.depth).toBeLessThan(0.12);
    expect(snap.position.distanceTo(clip.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(cord.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(pin.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(tab.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(stud.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(rivet.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(bead.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(clasp.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(loop.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(washer.position)).toBeGreaterThan(0.25);
    expect(snap.position.distanceTo(eyelet.position)).toBeGreaterThan(0.25);

    const prong = makeNametagProng();
    expect(prong.userData.part).toBe("prong");
    expect(prong.userData.mode).toBe("PAPER");
    expect(prong.geometry.type).toBe("BoxGeometry");
    expect((prong.material as THREE.MeshLambertMaterial).color.getHex()).toBe(0x6e4a32);
    const pr = (prong.geometry as THREE.BoxGeometry).parameters;
    expect(pr.width).toBeLessThan(0.12);
    expect(pr.height).toBeLessThan(0.12);
    expect(pr.depth).toBeLessThan(0.12);
    expect(prong.position.distanceTo(clip.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(cord.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(pin.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(tab.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(stud.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(rivet.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(bead.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(clasp.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(loop.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(washer.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(eyelet.position)).toBeGreaterThan(0.25);
    expect(prong.position.distanceTo(snap.position)).toBeGreaterThan(0.25);

    const slot = makeNametagSlot();
    expect(slot.userData.part).toBe("slot");
    expect(slot.userData.mode).toBe("PAPER");
    expect(slot.geometry.type).toBe("BoxGeometry");
    expect((slot.material as THREE.MeshLambertMaterial).color.getHex()).toBe(0x4a3220);
    const sl = (slot.geometry as THREE.BoxGeometry).parameters;
    expect(sl.width).toBeLessThan(0.12);
    expect(sl.height).toBeLessThan(0.12);
    expect(sl.depth).toBeLessThan(0.12);
    expect(slot.position.distanceTo(clip.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(cord.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(pin.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(tab.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(stud.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(rivet.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(bead.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(clasp.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(loop.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(washer.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(eyelet.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(snap.position)).toBeGreaterThan(0.25);
    expect(slot.position.distanceTo(prong.position)).toBeGreaterThan(0.25);

    const stitch = makeNametagStitch();
    expect(stitch.userData.part).toBe("stitch");
    expect(stitch.userData.mode).toBe("PAPER");
    expect(stitch.geometry.type).toBe("BoxGeometry");
    expect((stitch.material as THREE.MeshLambertMaterial).color.getHex()).toBe(0xf2d2a8);
    const sh = (stitch.geometry as THREE.BoxGeometry).parameters;
    expect(sh.width).toBeLessThan(0.12);
    expect(sh.height).toBeLessThan(0.12);
    expect(sh.depth).toBeLessThan(0.12);
    expect(stitch.position.distanceTo(clip.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(cord.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(pin.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(tab.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(stud.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(rivet.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(bead.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(clasp.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(loop.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(washer.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(eyelet.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(snap.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(prong.position)).toBeGreaterThan(0.25);
    expect(stitch.position.distanceTo(slot.position)).toBeGreaterThan(0.25);
