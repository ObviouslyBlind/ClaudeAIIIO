...
/**
 * PAPER wooden harbour sign on the south quay apron.
...
export const SIGN_LINE = "South port · PAPER";
...
function kraftFace() {
  if (typeof document === "undefined") {
    ...
    m.userData.mode = "PAPER";
    m.userData.kind = "south-sign-face";
...
/**
 * One wooden board on two posts. South quay only.
 * helpers.heightAt(spec, x, z) — same land height as quay.js
 */
export function makeSouthSign(spec, helpers) {
  if (!spec || spec.id !== "south") return null;
  ...
  g.name = "south-sign";
  g.userData.kind = "south-sign";
  g.userData.dress = "south-sign";
