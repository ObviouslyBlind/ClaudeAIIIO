...
function villagePump(_side) {
  ...
  /** Tiny kraft PAPER spigot on the pump spout. WOOD already in this file — PAPER box, not grey iron. */
  const spigot = part(0.04, 0.06, 0.04, WOOD, false);
  spigot.userData.part = "spigot";
