...
/** Tiny kraft PAPER bowl on the table — wood foot, plaster body, linen well. Boxes only. */
function makeBowl(x, y, z) {
  const g = new THREE.Group();
  g.name = "bowl";
  g.userData.kind = "interior-bowl";
  g.userData.mode = "PAPER";
  g.userData.part = "bowl";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "bowl" };
  g.add(box(0.07, 0.008, 0.07, WOOD, 0, 0.004, 0, "interior-bowl", paper));
  g.add(box(0.1, 0.032, 0.1, PLASTER, 0, 0.024, 0, "interior-bowl", paper));
  g.add(box(0.065, 0.01, 0.065, LINEN, 0, 0.038, 0, "interior-bowl", paper));
  return g;
}

/** Tiny kraft PAPER pitcher on the table — wood foot, plaster body, linen rim. Boxes only. */
function makePitcher(x, y, z) {
  const g = new THREE.Group();
  g.name = "pitcher";
  g.userData.kind = "interior-pitcher";
  g.userData.mode = "PAPER";
  g.userData.part = "pitcher";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "pitcher" };
  g.add(box(0.055, 0.008, 0.055, WOOD, 0, 0.004, 0, "interior-pitcher", paper));
  g.add(box(0.068, 0.05, 0.068, PLASTER, 0, 0.033, 0, "interior-pitcher", paper));
  g.add(box(0.042, 0.01, 0.042, LINEN, 0, 0.062, 0, "interior-pitcher", paper));
  return g;
}
...
/** Tiny kraft PAPER decanter on the table — wood foot, plaster body, linen stopper. Boxes only. */
function makeDecanter(x, y, z) {
  const g = new THREE.Group();
  g.name = "decanter";
  g.userData.kind = "interior-decanter";
  g.userData.mode = "PAPER";
  g.userData.part = "decanter";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "decanter" };
  g.add(box(0.024, 0.006, 0.024, WOOD, 0, 0.003, 0, "interior-decanter", paper));
  g.add(box(0.028, 0.046, 0.028, PLASTER, 0, 0.029, 0, "interior-decanter", paper));
  g.add(box(0.016, 0.01, 0.016, LINEN, 0, 0.057, 0, "interior-decanter", paper));
  return g;
}
...
function makeSaucer(x, y, z) {
  const g = new THREE.Group();
  g.name = "saucer";
  g.userData.kind = "interior-saucer";
  g.userData.mode = "PAPER";
  g.userData.part = "saucer";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "saucer" };
  g.add(box(0.09, 0.007, 0.09, WOOD, 0, 0.004, 0, "interior-saucer", paper));
  g.add(box(0.07, 0.007, 0.07, PLASTER, 0, 0.009, 0, "interior-saucer", paper));
  g.add(box(0.045, 0.006, 0.045, LINEN, 0, 0.014, 0, "interior-saucer", paper));
  return g;
}
...
/** Tiny kraft PAPER knife on the table — wood handle, linen bolster, plaster blade. Boxes only. */
function makeKnife(x, y, z) {
  const g = new THREE.Group();
  g.name = "knife";
  g.userData.kind = "interior-knife";
  g.userData.mode = "PAPER";
  g.userData.part = "knife";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "knife" };
  g.add(box(0.012, 0.008, 0.08, WOOD, 0, 0.006, 0.026, "interior-knife", paper));
  g.add(box(0.02, 0.008, 0.014, LINEN, 0, 0.007, -0.018, "interior-knife", paper));
  g.add(box(0.016, 0.006, 0.07, PLASTER, 0, 0.007, -0.058, "interior-knife", paper));
  return g;
}
...
/** Tiny kraft PAPER cup on the table — wood foot, plaster body, linen rim. Boxes only. */
function makeCup(x, y, z) {
  const g = new THREE.Group();
  g.name = "cup";
  g.userData.kind = "interior-cup";
  g.userData.mode = "PAPER";
  g.userData.part = "cup";
  g.position.set(x, y, z);
  const paper = { mode: "PAPER", part: "cup" };
  g.add(box(0.05, 0.01, 0.05, WOOD, 0, 0.005, 0, "interior-cup", paper));
  g.add(box(0.046, 0.06, 0.046, PLASTER, 0, 0.04, 0, "interior-cup", paper));
  g.add(box(0.05, 0.01, 0.05, LINEN, 0, 0.075, 0, "interior-cup", paper));
  return g;
}
...
export function makeInteriorScene() {
  ...
  // Kraft PAPER saucer on the table top — offset from mug, cup, plate, knife, fork, spoon, napkin, vase, book.
  down.add(makeSaucer(-0.8, 0.955, -0.7));
  // Kraft PAPER bowl on the table top — offset from saucer, mug, cup, plate, knife, fork, spoon, napkin, vase, book.
  ...
  // Kraft PAPER cup on the table top — offset from plate, knife, fork, spoon, napkin.
  down.add(makeCup(-0.28, 0.955, -0.68));
