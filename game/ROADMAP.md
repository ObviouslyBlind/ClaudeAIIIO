...
- **South first loop HUD:** no handheld wagon. Green tap-to-walk line. Floating chrome
  (leaderboard / account, **viewers** world / foot traffic / logistics / minerals,
  inventory / market / employees). **Click a $ tag** for the lot card (name, cost,
  Lease / Close). Market van drives up, drops a crate on the roadside, drives away.
  Place, stock, hire or run, earn $0.10 PAPER per dog.
  Labels: `reports/LABELS.md`.
