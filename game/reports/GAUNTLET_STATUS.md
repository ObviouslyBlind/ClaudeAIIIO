...
Piece in play: **South road corners — L joins, not pluses**.
...
- Network, not patches
- Harbour Circus is a ring the highway meets
- Block corners are an L of tarmac, not two strips crossing through each other
