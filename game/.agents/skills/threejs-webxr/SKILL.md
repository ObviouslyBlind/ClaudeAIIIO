...
name: threejs-webxr
description: >-
  WebXR integration for three.js. In Two Harbors, skip unless the operator names XR — play is phone Chrome + tap-to-walk, not VRButton.
  WebXRManager and XRManager on the renderer, session initialization patterns, VRButton and ARButton helpers, XRControllerModelFactory and hand model families, XREstimatedLight, XRPlanes, and related addon Webxr utilities.
...
> **Two Harbors:** WebXR is not the play path.
