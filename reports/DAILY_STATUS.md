...
- Pixel next: teal pier crate critic **in flight** at `http://localhost:8787/g/teal82` (`/g/plate79`–`81` FAIL PLATE — round stopped). Funnel/ring/brow/sign/lamp/cargo/plate rounds stay stopped. Do not restart play until teal82 finishes.
