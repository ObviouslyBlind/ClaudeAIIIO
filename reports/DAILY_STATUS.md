...
- Pixel next: rust hull waterline `http://localhost:8787/g/plate80` (`/g/plate79` FAIL PLATE — port cube behind the hull). Funnel/ring/brow/sign/lamp/cargo rounds stay stopped.
