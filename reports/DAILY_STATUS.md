...
- Pixel next: teal pier crate `http://localhost:8787/g/teal82` (`/g/plate79`–`81` FAIL PLATE — round stopped). Funnel/ring/brow/sign/lamp/cargo/plate rounds stay stopped.
